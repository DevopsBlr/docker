...
<h3><a class="ss">Transaction Details of Account Id : <%= tra.getAcc_id()%><%break;} %></a></h3>
<table  border="2" cellspacing="5" cellpadding="5" id="results">
<tr><th>Transaction id</th><th>Transaction date(YYYY-MM-DD)</th><th>Action</th><th>Amount (&#8377;)</th>
