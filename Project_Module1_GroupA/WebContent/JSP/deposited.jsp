...
<br>
<br>
<p class="aa" align="center"> Sum of <span class="WebRupee">&#x20B9;</span> <%=request.getAttribute("amount")%> was <a class="n" >Deposited Successfully</a> to AccountId : <%=request.getAttribute("accid")%></p>

<!-- <p class="aa" align="center"><strong>Your Amount has been Deposited Successfully </strong></p> -->
